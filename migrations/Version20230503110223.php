 ...
 */
final class Version20230503110223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE station CHANGE long_alt long_alt VARCHAR(20) DEFAULT NULL, CHANGE commune_id commune_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE station CHANGE commune_id commune_id INT NOT NULL, CHANGE long_alt long_alt VARCHAR(255) NOT NULL');
